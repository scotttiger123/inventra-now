...
const ListPayments = ({ navigation }) => {
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      loadPaymentsDataFromStorage()
        .then(data => {
         
          const sortedInvoices = data.sort((a, b) => new Date(b.manual_date) - new Date(a.manual_date));
          setInvoices(data);
          // console.log(" Listing Payments Data ", data)
        })
  ...
  const renderFooter = () => (
    <View style={styles.footerContainer}>
      ...
      >
        ...
        <Text style={styles.buttonText}>ADD PAYMENTS</Text>
      </TouchableOpacity>
    </View>
  );
